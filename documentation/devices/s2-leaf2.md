...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | default | 192.168.0.23/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD2_L3_RACK1 | Vlan4094 | 169.254.0.0 | Port-Channel2000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
| Ethernet4 | s2-host1_Ethernet2 | *trunk | *112,234 | *1 | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 10.0.0.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 10.0.0.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet4
   description s2-host1_Ethernet2
   no shutdown
...
| Port-Channel2000 | MLAG_PEER_s2-leaf1_Po2000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel2000
   description MLAG_PEER_s2-leaf1_Po2000
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.2.4/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.0.0.4 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.0.0.6 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 112 | 172.16.2.4:10112 | 10112:10112 | - | - | learned |
| 234 | 172.16.2.4:10234 | 10234:10234 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue | 172.16.2.4:10 | connected |
...
router bgp 65201
   ...
   neighbor 10.0.0.4 description s2-spine1_Ethernet3
   neighbor 10.0.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.6 remote-as 65200
   neighbor 10.0.0.6 description s2-spine2_Ethernet3
   neighbor 169.254.0.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.0.0 description s2-leaf1
