...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | default | 192.168.0.100/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD1_L3_RACK3 | Vlan4094 | 169.254.0.9 | Port-Channel2000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-brdr2_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
| Ethernet6 | MLAG_PEER_s1-brdr2_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet7 | routed | - | 10.0.0.17/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet7 | routed | - | 10.0.0.19/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_s2-brdr1_Ethernet4 | routed | - | 10.255.0.0/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2000 | MLAG_PEER_s1-brdr2_Po2000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel2000
   description MLAG_PEER_s1-brdr2_Po2000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.1.7/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  169.254.0.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.0.0.16 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.0.0.18 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.0.1 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65103
   ...
   neighbor 10.0.0.16 remote-as 65100
   neighbor 10.0.0.16 description s1-spine1_Ethernet7
   neighbor 10.0.0.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.18 remote-as 65100
   neighbor 10.0.0.18 description s1-spine2_Ethernet7
   neighbor 10.255.0.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.1 remote-as 65203
   neighbor 10.255.0.1 description s2-brdr1
   neighbor 169.254.0.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.0.9 description s1-brdr2
