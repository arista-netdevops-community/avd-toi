...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | default | 192.168.0.25/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD2_L3_RACK2 | Vlan4094 | 169.254.0.4 | Port-Channel2000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf3_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
| Ethernet4 | s2-host2_Ethernet2 | *trunk | *112,234 | *1 | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf3_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 2000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet5 | routed | - | 10.0.0.13/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet5 | routed | - | 10.0.0.15/31 | default | 1500 | False | - | - |
...
| Port-Channel2000 | MLAG_PEER_s2-leaf3_Po2000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel2000
   description MLAG_PEER_s2-leaf3_Po2000
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.2.6/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.0.0.12 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.0.0.14 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 112 | 172.16.2.6:10112 | 10112:10112 | - | - | learned |
| 234 | 172.16.2.6:10234 | 10234:10234 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue | 172.16.2.6:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.0.0.12 remote-as 65200
   neighbor 10.0.0.12 description s2-spine1_Ethernet5
   neighbor 10.0.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.14 remote-as 65200
   neighbor 10.0.0.14 description s2-spine2_Ethernet5
   neighbor 169.254.0.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.0.4 description s2-leaf3
